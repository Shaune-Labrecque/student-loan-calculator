...
if steps[step] == "Tuition & Fees":
    f["tuition"] = st.number_input("Enter your total tuition (incl. fees)", min_value=0.0, value=f["tuition"])
    ...
    f["income"] = st.number_input("Family income (Line 15000)", min_value=0.0, value=f["income"])
    ...
    f["dependents"] = st.number_input("Number of dependent children under 12", min_value=0, value=f["dependents"])
    ...
    f["disability_costs"] = st.number_input("Disability-related costs (services/equipment)", min_value=0.0, value=f["disability_costs"])
