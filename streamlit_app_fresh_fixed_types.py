...
if st.session_state.step == 0:
    ...
    f["tuition"] = st.number_input("Tuition & Fees", min_value=0.0, value=float(f["tuition"]))
    f["income"] = st.number_input("Family Income", min_value=0.0, value=float(f["income"]))
    if st.button("Next"):
    ...
    if f["disability"]:
        f["disability_amount"] = st.number_input("How much do you need for equipment/support?", min_value=0.0, value=float(f["disability_amount"]))
